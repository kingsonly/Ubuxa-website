              ...
              <div className="flex flex-col md:flex-row">
                <div className="md:w-1/2 bg-gradient-to-br from-blue-600 to-blue-800 p-10 md:p-16 text-white relative overflow-hidden">
                  <div className="relative z-10">
                    <h2 className="text-3xl md:text-4xl font-bold mb-6">Ready to Transform Your Energy Business?</h2>
                    <p className="text-blue-100 text-lg mb-8">
                      Request a personalized demo and discover how Ubuxa can streamline your operations.
                    </p>
                    <div className="space-y-6">
                      <div className="flex items-center">
                        ...
                        <p className="font-medium">Custom tailored subscription plans</p>
                      </div>
                      <div className="flex items-center">
                        <div className="h-10 w-10 rounded-full bg-white/20 flex items-center justify-center mr-4">
                          <CheckCircle className="h-6 w-6 text-white" />
                        </div>
                        <p className="font-medium">Direct payment gateway integration</p>
                      </div>
                      <div className="flex items-center">
                        <div className="h-10 w-10 rounded-full bg-white/20 flex items-center justify-center mr-4">
                          <CheckCircle className="h-6 w-6 text-white" />
                        </div>
                        <p className="font-medium">Comprehensive onboarding support</p>
                      </div>
                    </div>
                  </div>
                  {/* Decorative circles */}
                ...
                <div className="md:w-1/2 p-10 md:p-16">
                  ...
                  <form className="space-y-6">
                    ...
                    <div>
                      ...
                      <select className="w-full rounded-lg border border-gray-300 px-4 py-3 text-gray-900 focus:border-blue-500 focus:ring-blue-500">
